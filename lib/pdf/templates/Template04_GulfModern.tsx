/**
 * Template 04 — Gulf Modern
 * Audience: Hospitality, retail, marketing, mid-career professionals.
 * Layout: single column, modern green accent, balanced. ATS-safe.
 */
...
export function Template04_GulfModern({ data }: TemplateProps) {
  const theme = THEMES['gulf-modern']
